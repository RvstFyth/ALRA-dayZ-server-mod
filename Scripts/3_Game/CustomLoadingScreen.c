...
const string LOADING_SCREENS_PATH 	= "AlraServerMod/Data/LoadingImages.json";
const string LOADING_MESSAGES_PATH 	= "AlraServerMod/Data/LoadingMessages.json";
const string LOADING_SCREEN_LOGO 	= "AlraServerMod/Pictures/loading_screen_1_co.edds";
									//! ModName/Path/File
